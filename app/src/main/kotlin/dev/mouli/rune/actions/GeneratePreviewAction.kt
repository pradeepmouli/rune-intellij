...
import dev.mouli.rune.generation.GenerationRequest
import dev.mouli.rune.generation.RuneJavaGeneratorAdapter
import dev.mouli.rune.settings.RuneProjectConfiguration
        ...
        try {
            ...
            ApplicationManager.getApplication().invokeLater {
                if (result.success) {
                    ...
                    val errors =
                        result.diagnostics
                            .filter { it.severity == dev.mouli.rune.generation.DiagnosticSeverity.ERROR }
                            .joinToString("\n") { it.message }
